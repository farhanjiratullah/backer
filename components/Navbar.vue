      ...
      <div class="dropdown inline-block relative z-10">
        ...
        >
          <img
            ...
            :src="`${$axios.defaults.baseURL}/${this.$auth.user.image_url}`"
        ...
        >
          <li>
            <NuxtLink
              :to="{ name: 'dashboard' }"
              class="bg-white hover:bg-gray-100 hover:text-orange-500 py-2 px-4 block whitespace-nowrap cursor-pointer"
          ...
          <li>
            <NuxtLink
              :to="{ name: 'dashboard' }"
              class="bg-white hover:bg-gray-100 hover:text-orange-500 py-2 px-4 block whitespace-nowrap cursor-pointer"
              >Account Setting</NuxtLink
            >
          </li>
          <li>
            <a
              @click="logout()"
              class="bg-white hover:bg-gray-100 hover:text-orange-500 py-2 px-4 block whitespace-nowrap cursor-pointer rounded-b"
              >Logout</a
            >
          </li>
        </ul>
